		...
		<div :style='{"padding":"20px 20px 0","display":"flex","height":"calc(100vh - 95px)"}'>
			<div :style='{"width":"30%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="toptenChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="toptenChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"alignContent":"center","padding":"0","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","height":"100px","order":"1"}'>
					...
					<div :style='{"margin":"0 10px 0 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231223/9c1f0d184ede4dee8925bb6c57ba14b7.png) no-repeat center top / 100% 100%","flexDirection":"column","flex":"1","display":"flex","width":"calc(20% - 10px)","justifyContent":"center","height":"100%"}'>
						...
						<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column-reverse","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>十大成交股总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{toptenCount}}</div>
						</div>
					</div>
				</div>
				<div class="tables">
					<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","width":"100%","fontSize":"16px","height":"42px"}'>十大成交股(排名TOP10)</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"rgba(92,135,230,.3)","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						<el-table-column :resizable="true" :sortable="false" prop="stockcode" label="股票代码"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="stockname" label="股票简称"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="buybalance" label="买入金额"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="sellbalance" label="卖出金额"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="balance" label="成交金额"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="netbuying" label="净买额"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="ranking" label="排名"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"width":"30%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="toptenChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="toptenChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="toptenChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
...
//统计接口1
    toptenChat1() {
      this.$nextTick(()=>{
        ...
        var toptenChart1 = echarts.init(document.getElementById("toptenChart1"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                toptenChart1.setOption(option);
				
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, toptenChart1)
...
//统计接口2
    toptenChat2() {
      this.$nextTick(()=>{
        ...
        var toptenChart2 = echarts.init(document.getElementById("toptenChart2"),'macarons');
        this.$http({
...
//统计接口3
    toptenChat3() {
      this.$nextTick(()=>{
        ...
        var toptenChart3 = echarts.init(document.getElementById("toptenChart3"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				seriesObj = Object.assign(seriesObj , this.pie2?this.pie2.series:this.pie.series)
                ...
                option = {
					backgroundColor: this.pie2?this.pie2.backgroundColor:this.pie.backgroundColor,
					color: this.pie2?this.pie2.color:this.pie.color,
					title: titleObj,
					legend: legendObj,
					tooltip: tooltipObj,
					grid: gridObj,
...
//统计接口4
    toptenChat4() {
      this.$nextTick(()=>{
        ...
        var toptenChart4 = echarts.init(document.getElementById("toptenChart4"),'macarons');
        this.$http({
...
//统计接口5
    toptenChat5() {
      this.$nextTick(()=>{
        ...
        var toptenChart5 = echarts.init(document.getElementById("toptenChart5"),'macarons');
        this.$http({
