<template>
	<div class="navbar">
		<div class="title" :style='{"margin":"0","top":"2px","textAlign":"center","left":"50px","background":"none","display":"block","width":"auto","position":"absolute","order":"1"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"60px","fontSize":"21px","color":"#fff","fontWeight":"500"}'>{{this.$project.projectName}}</span>
		</div>
		<!--
		...
		<el-dropdown @command="handleCommand" trigger="click" :style='{"padding":"0px","margin":"0 25px 0 0","color":"inherit","background":"none","display":"inline-block","fontSize":"inherit","order":"10"}'>
		  <div class="el-dropdown-link" :style='{"border":"1px solid #F1F2F7","padding":"4px 8px 4px 0","alignItems":"center","borderRadius":"4px","background":"url() no-repeat right center","display":"flex"}'>
		    <el-image v-if="user" :style='{"border":"0px solid #727b84","margin":"0 10px","objectFit":"cover","borderRadius":"4px","display":"inline-block","width":"30px","height":"30px"}' :src="avatar?this.$base.url + avatar : require('@/assets/img/avator.png')" fit="cover"></el-image>
		    <span :style='{"lineHeight":"32px","fontSize":"inherit","color":"#fff","display":"block"}'>{{this.$storage.get('adminName')}}</span>
		    <span class="icon iconfont icon-xiala" :style='{"margin":"0 0 0 5px","fontSize":"8px","color":"#fff","display":"block"}'></span>
		  </div>
